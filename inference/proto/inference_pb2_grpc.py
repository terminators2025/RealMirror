...
class InferenceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Predict = channel.unary_unary(
            ...
            request_serializer=inference_pb2.InferenceRequest.SerializeToString,
...
def add_InferenceServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "Predict": grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=inference_pb2.InferenceResponse.SerializeToString,
        ),
    }
...
class InferenceService(object):
    ...
    def Predict(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/inference.InferenceService/Predict",
            inference_pb2.InferenceRequest.SerializeToString,
            inference_pb2.InferenceResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
